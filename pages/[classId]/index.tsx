    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta
                    name="description"
                    content={props.classData?.subject}
                ></meta>
            </Head>
            <EditClassForm
                subject={props.classData.subject}
                startDate={props.classData.startDate}
                endDate={props.classData.endDate}
                onUpdateClass={updateClassHandler}
            />
        </Fragment>
    );
};
...
export const getServerSideProps = withSession(async (context) => {
    ...
    if (selectedClass) {
        ...
        const startDate =
            selectedClass.startDate.getFullYear() +
            "-" +
            startMonth +
            "-" +
            startDay;
        const endDate =
            selectedClass.endDate.getFullYear() + "-" + endMonth + "-" + endDay;
