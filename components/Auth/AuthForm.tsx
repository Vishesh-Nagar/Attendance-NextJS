...
const isCorrectPassword = (value: string) =>
    isNotEmpty(value) && value.length >= 5;

const AuthForm: React.FC<{ onLogin: (data: SignUp | SignIn) => void }> = (
    props
) => {
    ...
    const fullNameClasses = !fullNameInputHasError
        ? classes.control
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className={passwordClasses}>
                    ...
                    {passwordInputHasError && (
                        <p className={classes["error-text"]}>
                            Please enter a valid password (min length 5
                            characters)
                        </p>
                    )}
                </div>
