...
const NewClassForm: React.FC<{ onAddClass: (classData: NewClass) => void }> = (
    props
) => {
    const {
    ...
    const startDateClasses = !startDateInputHasError
        ? classes.control
        : classes.control + " " + classes.invalid;
    const endDateClasses = !endDateInputHasError
        ? classes.control
        : classes.control + " " + classes.invalid;
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className={endDateClasses}>
                    ...
                    <input
                        ...
                        value={enteredEndDate}
                        onBlur={endDateBlurHanlder}
                        aria-label="endDate-input"
                    />
