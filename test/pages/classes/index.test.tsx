...
describe("Classes page", () => {
    ...
    test("renders classes dates when there are classes", () => {
        ...
        const englishStartDateElement = screen.getByText("Wed May 05 2021", {
            exact: false,
        });
        expect(englishStartDateElement).toBeInTheDocument();
        const englishEndDateElement = screen.getByText("Tue May 25 2021", {
            exact: false,
        });
        expect(englishEndDateElement).toBeInTheDocument();
        const scienceStartDateElement = screen.getByText("Thu May 20 2021", {
            exact: false,
        });
        expect(scienceStartDateElement).toBeInTheDocument();
        const scienceEndDateElement = screen.getByText("Sun May 30 2021", {
            exact: false,
        });
    ...
    describe("Students", () => {
        ...
        test("does not render approve/reject button", async () => {
            ...
            expect(
                screen.queryByText("Approve/Reject")
